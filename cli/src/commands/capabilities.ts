...
const CAPABILITIES: Record<string, Capability[]> = {
  ...
  "🤖 AI": [
    ...
    { name: "AI Conversations", description: "Create, retrieve, list, update, add messages to, and delete AI assistant conversations", actions: ["create_ai_conversation", "get_ai_conversation", "list_ai_conversations", "update_ai_conversation", "add_ai_conversation_message", "delete_ai_conversation"] },
...
const COMPOSITE_COMMANDS = [
  ...
  { name: "telnyx-agent create-ai-conversation", description: "Create an AI conversation for assistant messages" },
  { name: "telnyx-agent get-ai-conversation", description: "Retrieve one AI conversation by ID" },
  { name: "telnyx-agent list-ai-conversations", description: "List AI conversations with generated filters" },
  { name: "telnyx-agent update-ai-conversation", description: "Update metadata for an AI conversation" },
  { name: "telnyx-agent add-ai-conversation-message", description: "Add a message to an AI conversation" },
  { name: "telnyx-agent delete-ai-conversation", description: "Delete an AI conversation with explicit confirmation" },
