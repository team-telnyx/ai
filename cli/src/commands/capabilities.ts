...
const CAPABILITIES: Record<string, Capability[]> = {
  ...
  "🤖 AI": [
    ...
    { name: "Assistants", description: "Create, manage, execute, validate, and schedule AI assistants", actions: ["list_ai_assistants", "create_ai_assistant", "get_ai_assistant", "update_ai_assistant", "delete_ai_assistant", "chat_ai_assistant", "send_ai_assistant_sms", "trigger_ai_assistant_test_run", "get_ai_assistant_test_run", "list_ai_assistant_test_runs", "test_ai_assistant_tool", "create_ai_assistant_scheduled_event", "get_ai_assistant_scheduled_event", "list_ai_assistant_scheduled_events", "cancel_ai_assistant_scheduled_event"] },
...
const COMPOSITE_COMMANDS = [
  ...
  { name: "telnyx-agent create-ai-assistant-scheduled-event", description: "Schedule a future phone call or SMS for an AI assistant" },
  { name: "telnyx-agent get-ai-assistant-scheduled-event", description: "Retrieve one scheduled event by assistant and event IDs" },
  { name: "telnyx-agent list-ai-assistant-scheduled-events", description: "List and filter scheduled events for an AI assistant" },
  { name: "telnyx-agent cancel-ai-assistant-scheduled-event", description: "Cancel a pending scheduled event, or remove its record, with explicit confirmation" },
